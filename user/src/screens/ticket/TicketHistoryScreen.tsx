...
const fallbackBookings: LiteBooking[] = [
  ...
  {
    id: 'booking-dummy-paid-2',
    status: 'PAID',
    quantity: 4,
    totalPrice: 300000,
    session: { mountain: { name: 'Gunung Pesagi' }, date: '2026-06-19T06:00:00+07:00' },
  },
  {
    id: 'booking-dummy-paid-1',
    status: 'PAID',
    quantity: 1,
    totalPrice: 75000,
    session: { mountain: { name: 'Gunung Pesagi' }, date: '2026-06-18T06:00:00+07:00' },
  },
  {
    id: 'booking-dummy-pending-1',
  ...
  {
    id: 'booking-dummy-cancelled-2',
    status: 'CANCELLED',
    quantity: 3,
    totalPrice: 225000,
    session: { mountain: { name: 'Gunung Pesagi' }, date: '2026-06-08T06:30:00+07:00' },
  },
];
