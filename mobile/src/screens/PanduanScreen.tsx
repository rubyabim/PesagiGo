...
const guides = [
  ...
  { title: 'Manajemen Perjalanan', desc: 'Cara mengatur waktu, bekal, dan istirahat selama pendakian.' },
  ...
  { title: 'Flora Fauna Khas', desc: 'Mengenal ekosistem endemik di sepanjang jalur.' },
];
